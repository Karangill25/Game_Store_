...
let game_left_1_btn = document.getElementById('game_bx_left_1_btn');
let game_right_1_btn = document.getElementById('game_bx_right_1_btn');

game_left_1_btn.addEventListener('click', () => {
  game_bx_1.scrollLeft -= 250;
});

game_right_1_btn.addEventListener('click', () => {
  game_bx_1.scrollLeft += 250;
});
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const sections = [
    { container: '.game1', cardSelector: 'h5' },
